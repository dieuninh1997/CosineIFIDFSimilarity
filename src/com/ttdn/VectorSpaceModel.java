...
public class VectorSpaceModel {
    ...
    /**
     * The tf-idf weight vectors. The hashmap maps a document to another
     * hashmap. The second hashmap maps a term to its tf-idf weight for this
     * document.
     */
    ...
    private void createTfIdfWeights() {
        ...
        Set<String> terms = corpus.getInvertedIndex().keySet();//ds term
...
//                System.out.println("Weights: "+weight);
     ...
     * @return the magnitude độ lớn của vector
     */
    ...
    /**
     * This will return the cosine similarity of two documents. This will range
     * from 0 (not similar) to 1 (very similar).
     *
     * @param d1 Document 1
     * @param d2 Document 2
